...
>>>>>>> 219abd36599a1acddd9505b34939ae3db466a2e8
              <li>
                <Link
                  className="font-menu text-sm lg:text-lg xl:text-xl 2xl:text-2xl text-gray-400 hover:text-gray-500"
                  href={"#"}
                >
                  {item.name}
                </Link>
...
>>>>>>> 219abd36599a1acddd9505b34939ae3db466a2e8
        ...
        <div>
          {" "}
          <a
            className="hidden transition-all duration-200 lg:inline-block  lg:ml-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-xl text-gray-900 font-menu rounded-xl"
            href="#"
          >
            ورود
          </a>
          <a
            className="hidden transition-all duration-200 lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-xl text-white font-menu rounded-xl"
            href="#"
          >
            ثبت نام
          </a>
...
=======
                  className="block px-4 py-3 mb-3 leading-loose text-xl text-center font-menu bg-gray-50 hover:bg-gray-100 rounded-xl"
>>>>>>> 219abd36599a1acddd9505b34939ae3db466a2e8
                  href="#"
                >
                  ورود
...
=======
              <p className="my-4 font-Alertdescription text-xl text-center text-gray-400">
                <span>
