        ...
        <div className="navbar-menu relative z-50">
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
              ...
              <ul>
                {NavList.map((item, index) => (
                  <li key={index} className="mb-1">
                    <Link
                      className="block p-4 text-2xl font-menu *: text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                      href={"#"}
                    >
                      {item.name}
                    </Link>
            ...
            <div className="mt-auto">
              <div className="pt-6">
                <a
                  className="block px-4 py-3 mb-3 leading-loose text-xl text-center font-menu bg-gray-800 hover:bg-gray-400 rounded-xl"
                  href="#"
                >
                  ورود
                </a>
                <a
                  className="block px-4 py-3 mb-2 leading-loose text-xl text-center text-white font-menu bg-blue-600 hover:bg-blue-700  rounded-xl"
                  href="#"
                >
                  ثبت نام
                </a>
