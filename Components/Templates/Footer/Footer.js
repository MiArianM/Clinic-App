...
function Footer() {
  return (
    <footer className="bg-slate-100 dark:bg-gray-900 pt-10">
      <hr className="w-1/2 container border-fuchsia-500 dark:border-indigo-500 " />
      <Posts />
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="font-menu lg:flex lg:justify-between items-center">
            ...
            {FootList.map((item, index) => (
              <div key={index}>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  <li className="mb-4">
                    <Link href={item.route1} className="hover:underline">
                      {item.sub1}
                    </Link>
                  </li>
                  <li>
                    <Link href={item.route2} className="hover:underline">
                      {item.sub2}
                    </Link>
                  </li>
                </ul>
